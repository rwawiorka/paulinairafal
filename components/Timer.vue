<template>
    <div class="top-[calc(75%)] absolute left-1/2 -translate-x-1/2 -translate-y-1/2">
        <ul id="countdown" class="flex justify-center items-center gap-4 text-slate-100">
            ...
            <li>
                <span class="hours block text-4xl md:text-5xl font-normal leading-none m-auto mt-0 mb-0 text-center">
            ...
            <li>
                <span class="minutes block text-4xl md:text-5xl font-normal leading-none m-auto mt-0 mb-0 text-center">
            ...
            <li>
                <span class="seconds block text-4xl md:text-5xl font-normal leading-none m-auto mt-0 mb-0 text-center">
